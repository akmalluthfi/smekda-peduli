            ...
            <form class="row g-3" method="POST" action="{{ route('faqs.update', $faq->id) }}">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control @error('question') is-invalid @enderror" id="question"
                  name="question" value="{{ old('question', $faq->question) }}" placeholder="Masukkan pertanyaan"
                  required>
                @error('question')
              ...
              <div class="col-12">
                ...
                <textarea class="form-control @error('answer') is-invalid @enderror" id="answer" rows="3" name="answer"
                  placeholder="Berikan jawaban atas pertanyaan sebelumnya" required>{{ old('answer', $faq->answer) }}</textarea>
                @error('answer')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
